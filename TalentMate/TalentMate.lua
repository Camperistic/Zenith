...
-- ---------------------------------------------------------------------------
-- Wago Analytics (optional, anonymous, opt-in by the player). If the user runs
-- the Wago App it provides the real WagoAnalytics library; the embedded shim
-- (libs\WagoAnalyticsShim) registers against it using the ## X-Wago-ID from the
-- .toc and reports anonymous AGGREGATE usage -- which class/spec people apply
-- and how often. Without the Wago App (or an X-Wago-ID) the shim hands back a
-- no-op object, so every aCount/aSwitch below is a safe no-op and NOTHING is
-- ever collected. See https://addons.wago.io/docs/analytics.
-- ---------------------------------------------------------------------------
local analytics
do
    local lib = LibStub and LibStub("WagoAnalytics", true)
    local meta = C_AddOns and C_AddOns.GetAddOnMetadata or GetAddOnMetadata
    local wagoID = lib and meta and meta(ADDON_NAME, "X-Wago-ID")
    if wagoID and wagoID ~= "" then analytics = lib:Register(wagoID) end
end
local function aCount(name)  if analytics then analytics:IncrementCounter(name) end end
local function aSwitch(name) if analytics then analytics:Switch(name) end end
...
local BUILDS = {
    WARRIOR = {
        { category="pve", label="Fury (Raid DPS)", useCase="Raid DPS: top sustained-DPS warrior spec. Dual-wields two fast weapons; relies on Bloodthirst, Flurry and a maintained Rampage. This is the default raiding DPS warrior build. Pick over Arms when your raid already has the physical-damage buff covered.", talents={ {"Improved Heroic Strike",3},{"Deflection",3},{"Improved Charge",2},{"Improved Thunder Clap",3},{"Anger Management",1},{"Deep Wounds",3},{"Improved Overpower",1},{"Impale",2},{"Cruelty",5},{"Unbridled Wrath",5},{"Commanding Presence",5},{"Dual Wield Specialization",5},{"Improved Execute",2},{"Enrage",5},{"Improved Slam",2},{"Flurry",5},{"Precision",2},{"Bloodthirst",1},{"Improved Berserker Stance",5},{"Rampage",1} } },
        { category="pve", label="Arms (Raid DPS / Blood Frenzy)", useCase="Raid DPS spec that brings Blood Frenzy (raid-wide +4% physical damage) and Mortal Strike. Slightly lower personal DPS than Fury but the raid buff plus consistent two-hander damage makes it a valued support DPS slot, especially when the raid lacks the physical-damage buff.", talents={ {"Improved Heroic Strike",3},{"Improved Rend",2},{"Improved Charge",2},{"Improved Thunder Clap",3},{"Improved Overpower",2},{"Anger Management",1},{"Deep Wounds",3},{"Two-Handed Weapon Specialization",5},{"Impale",2},{"Poleaxe Specialization",5},{"Improved Disciplines",2},{"Mortal Strike",1},{"Blood Frenzy",2},{"Cruelty",5},{"Unbridled Wrath",5},{"Commanding Presence",5},{"Enrage",5},{"Weapon Mastery",2},{"Sweeping Strikes",1},{"Improved Slam",2},{"Flurry",3} } },
        { category="pve", label="Protection (Raid/Heroic Tank)", useCase="Main tank build for raids and Heroic dungeons. Maximizes threat (Shield Slam, Devastate, Defiance, Focused Rage, One-Handed Weapon Specialization) and survivability (Anticipation for crit immunity, Toughness, Shield Specialization, Shield Mastery). THE warrior tanking spec.", talents={ {"Improved Heroic Strike",3},{"Deflection",2},{"Improved Charge",2},{"Cruelty",5},{"Improved Bloodrage",2},{"Tactical Mastery",3},{"Anticipation",5},{"Shield Specialization",5},{"Toughness",5},{"Improved Shield Block",1},{"Last Stand",1},{"Improved Revenge",3},{"Defiance",3},{"Improved Sunder Armor",3},{"Concussion Blow",1},{"Shield Mastery",3},{"One-Handed Weapon Specialization",5},{"Focused Rage",3},{"Shield Slam",1},{"Vitality",4},{"Devastate",1} } },
        { category="pvp", label="Arms (Arena 2v2/3v3)", useCase="The dominant warrior PvP/arena spec. Deep Arms (41 pts) for Mortal Strike (50% healing reduction), Improved Mortal Strike, Endless Rage, Second Wind, Improved Intercept, Improved Hamstring and weapon specialization. Excellent in 2v2 Warrior/Healer and 3v3 cleaves; burst plus the all-important MS healing debuff.", talents={ {"Improved Heroic Strike",3},{"Deflection",2},{"Improved Charge",2},{"Improved Thunder Clap",3},{"Anger Management",1},{"Deep Wounds",3},{"Improved Overpower",1},{"Two-Handed Weapon Specialization",5},{"Impale",2},{"Death Wish",1},{"Sword Specialization",5},{"Improved Intercept",2},{"Improved Hamstring",3},{"Improved Disciplines",3},{"Blood Frenzy",2},{"Mortal Strike",1},{"Second Wind",2},{"Improved Mortal Strike",5},{"Endless Rage",1},{"Cruelty",5},{"Booming Voice",5},{"Piercing Howl",1},{"Tactical Mastery",3} } },
        { category="pvp", label="Arms/Prot (Battlegrounds / Survival)", useCase="Battleground / world-PvP hybrid. Deep enough Arms (30 pts) for Mortal Strike, Second Wind and Improved Hamstring, then a 21-point Protection dip for Anticipation, Toughness, Last Stand and the Concussion Blow stun. Niche vs. the 41/20/0 arena build but a real survivability-focused setup for objective BGs and world PvP where staying alive and snaring beats peak burst.", talents={ {"Improved Heroic Strike",3},{"Deflection",3},{"Improved Charge",2},{"Improved Thunder Clap",3},{"Anger Management",1},{"Deep Wounds",3},{"Improved Overpower",2},{"Two-Handed Weapon Specialization",5},{"Impale",2},{"Death Wish",1},{"Improved Hamstring",3},{"Improved Disciplines",3},{"Blood Frenzy",2},{"Second Wind",2},{"Mortal Strike",1},{"Tactical Mastery",3},{"Improved Bloodrage",2},{"Anticipation",5},{"Shield Specialization",5},{"Toughness",5},{"Improved Shield Block",1},{"Last Stand",1},{"Improved Revenge",2},{"Concussion Blow",1} } },
        { category="leveling", label="Arms (10-70)", useCase="Standard TBC 2H Arms leveling build: rushes Deep Wounds + Two-Handed Weapon Specialization + Mortal Strike for big single-target burst and Sweeping Strikes for cleave, then fills Fury (Cruelty/Unbridled Wrath/Commanding Presence/Enrage/Flurry) for sustained crit, rage, and damage - fast, durable, low-downtime questing.", order={ "Improved Heroic Strike","Improved Heroic Strike","Improved Heroic Strike","Deflection","Deflection","Deflection","Deflection","Deflection","Improved Charge","Improved Charge","Improved Thunder Clap","Improved Thunder Clap","Deep Wounds","Deep Wounds","Deep Wounds","Improved Overpower","Improved Overpower","Anger Management","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Impale","Impale","Poleaxe Specialization","Poleaxe Specialization","Poleaxe Specialization","Poleaxe Specialization","Poleaxe Specialization","Mortal Strike","Tactical Mastery","Tactical Mastery","Tactical Mastery","Cruelty","Cruelty","Cruelty","Cruelty","Cruelty","Booming Voice","Booming Voice","Booming Voice","Unbridled Wrath","Unbridled Wrath","Unbridled Wrath","Unbridled Wrath","Unbridled Wrath","Commanding Presence","Commanding Presence","Commanding Presence","Commanding Presence","Commanding Presence","Enrage","Enrage","Enrage","Enrage","Enrage","Improved Execute","Improved Execute","Flurry","Flurry" }, talents={ {"Improved Heroic Strike",3},{"Deflection",5},{"Improved Charge",2},{"Improved Thunder Clap",2},{"Anger Management",1},{"Improved Overpower",2},{"Deep Wounds",3},{"Two-Handed Weapon Specialization",5},{"Impale",2},{"Poleaxe Specialization",5},{"Mortal Strike",1},{"Tactical Mastery",3},{"Cruelty",5},{"Booming Voice",3},{"Unbridled Wrath",5},{"Commanding Presence",5},{"Enrage",5},{"Improved Execute",2},{"Flurry",2} } },
    },
    PALADIN = {
        { category="pve", label="Ret (Raid DPS)", useCase="Raid melee DPS. The mainstay PvE damage spec; brings Sanctity Aura, Improved Seal of the Crusader and Judgement of the Crusader, plus strong physical/holy burst. Take this when you want to deal damage in raids and 5-mans.", talents={ {"Benediction",5},{"Improved Judgement",2},{"Improved Seal of the Crusader",3},{"Deflection",2},{"Conviction",5},{"Seal of Command",1},{"Pursuit of Justice",2},{"Crusade",3},{"Two-Handed Weapon Specialization",3},{"Sanctity Aura",1},{"Improved Sanctity Aura",2},{"Vengeance",5},{"Sanctified Judgement",3},{"Sanctified Seals",3},{"Repentance",1},{"Fanaticism",4},{"Crusader Strike",1},{"Improved Devotion Aura",5},{"Precision",3},{"Toughness",2},{"Blessing of Kings",1},{"Anticipation",4} } },
        ...
        { category="pve", label="Holy (Healer)", useCase="Raid and dungeon main healer. The premier single-target tank healer thanks to Illumination mana returns, Divine Favor, Light's Grace and Holy Shock. Take this for any healing role; it is the standard and essentially only Holy build.", talents={ {"Divine Intellect",5},{"Spiritual Focus",5},{"Healing Light",3},{"Aura Mastery",1},{"Improved Lay on Hands",1},{"Illumination",5},{"Improved Blessing of Wisdom",1},{"Divine Favor",1},{"Sanctified Light",3},{"Purifying Power",1},{"Holy Power",5},{"Light's Grace",3},{"Holy Shock",1},{"Holy Guidance",5},{"Divine Illumination",1},{"Improved Devotion Aura",5},{"Guardian's Favor",2},{"Toughness",4},{"Blessing of Kings",1},{"Anticipation",5},{"Improved Concentration Aura",3} } },
        { category="pvp", label="Ret (Arena/BG)", useCase="Arena (2v2/3v3) and battlegrounds burst DPS. Deep Ret for Repentance CC, Crusader Strike and Seal of Command burst, with Protection for Stoicism (stun/dispel resist) and survivability. The main Paladin PvP damage build.", talents={ {"Redoubt",5},{"Toughness",5},{"Precision",3},{"Blessing of Kings",1},{"Anticipation",1},{"Stoicism",2},{"Benediction",5},{"Improved Judgement",2},{"Deflection",3},{"Vindication",3},{"Conviction",5},{"Seal of Command",1},{"Pursuit of Justice",2},{"Crusade",3},{"Two-Handed Weapon Specialization",3},{"Vengeance",5},{"Sanctified Judgement",3},{"Sanctified Seals",3},{"Repentance",1},{"Fanaticism",4},{"Crusader Strike",1} } },
        { category="pvp", label="Holy (Arena)", useCase="Arena (2v2/3v3) and rated battleground healer. The dominant Paladin PvP spec: extremely strong single-target healing with Holy Shock burst-heal, Divine Favor, Improved Hammer of Justice and Stoicism for survivability under pressure. Take this to heal in PvP.", talents={ {"Divine Intellect",5},{"Spiritual Focus",5},{"Healing Light",3},{"Aura Mastery",1},{"Improved Lay on Hands",2},{"Illumination",5},{"Divine Favor",1},{"Sanctified Light",3},{"Purifying Power",1},{"Holy Power",5},{"Light's Grace",3},{"Holy Shock",1},{"Holy Guidance",5},{"Divine Illumination",1},{"Redoubt",5},{"Toughness",5},{"Guardian's Favor",2},{"Blessing of Kings",1},{"Anticipation",2},{"Improved Hammer of Justice",3},{"Stoicism",2} } },
        { category="leveling", label="Retribution (10-70)", useCase="Retribution is the standard Paladin leveling spec: it has the best solo DPS/kill speed of the three trees, scales with 2H weapons, and stays mana/health efficient via Benediction, Sanctified Judgement, and plate self-sustain so you rarely die or drink.", order={ "Benediction","Benediction","Benediction","Benediction","Benediction","Improved Judgement","Improved Judgement","Improved Seal of the Crusader","Improved Seal of the Crusader","Improved Seal of the Crusader","Seal of Command","Pursuit of Justice","Pursuit of Justice","Pursuit of Justice","Deflection","Deflection","Deflection","Deflection","Deflection","Conviction","Conviction","Conviction","Conviction","Conviction","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Two-Handed Weapon Specialization","Crusade","Crusade","Crusade","Sanctity Aura","Sanctified Judgement","Sanctified Judgement","Sanctified Judgement","Vengeance","Vengeance","Vengeance","Vengeance","Improved Sanctity Aura","Improved Sanctity Aura","Sanctified Seals","Sanctified Seals","Sanctified Seals","Repentance","Fanaticism","Fanaticism","Fanaticism","Fanaticism","Crusader Strike","Divine Strength","Divine Strength","Divine Strength","Divine Strength","Divine Strength","Divine Intellect","Divine Intellect","Divine Intellect","Divine Intellect","Divine Intellect","Spiritual Focus","Spiritual Focus" }, talents={ {"Benediction",5},{"Improved Judgement",2},{"Improved Seal of the Crusader",3},{"Seal of Command",1},{"Pursuit of Justice",3},{"Deflection",5},{"Conviction",5},{"Two-Handed Weapon Specialization",3},{"Crusade",3},{"Sanctity Aura",1},{"Sanctified Judgement",3},{"Vengeance",4},{"Improved Sanctity Aura",2},{"Sanctified Seals",3},{"Repentance",1},{"Crusader Strike",1},{"Fanaticism",4},{"Divine Strength",5},{"Divine Intellect",5},{"Spiritual Focus",2} } },
    },
    HUNTER = {
    ...
    ROGUE = {
        { category="pve", label="Combat Swords", useCase="Raid DPS (primary). The meta TBC Rogue raiding spec - highest sustained single-target physical DPS via Sinister Strike spam, Combat Potency energy returns, and Surprise Attacks (which also makes finishers undodgeable). Pick this for any raid where another rogue or a warrior already supplies the armor debuff (Improved Expose Armor or Sunder Armor).", talents={ {"Malice",5},{"Improved Eviscerate",2},{"Ruthlessness",3},{"Relentless Strikes",1},{"Lethality",5},{"Improved Sinister Strike",2},{"Lightning Reflexes",4},{"Improved Slice and Dice",3},{"Precision",5},{"Endurance",2},{"Dual Wield Specialization",5},{"Blade Flurry",1},{"Sword Specialization",5},{"Weapon Expertise",2},{"Aggression",3},{"Vitality",2},{"Adrenaline Rush",1},{"Combat Potency",5},{"Surprise Attacks",1},{"Opportunity",4} } },
        { category="pve", label="Combat + Imp EA", useCase="Raid DPS for the designated armor-debuffer. Sacrifices a sliver of personal DPS to provide Improved Expose Armor (a deeper armor reduction than Sunder Armor) which boosts the ENTIRE physical raid. Exactly one rogue per raid runs this; it is a net raid-DPS gain when no other source of the deep armor debuff is present.", talents={ {"Malice",5},{"Remorseless Attacks",2},{"Ruthlessness",3},{"Improved Expose Armor",2},{"Relentless Strikes",1},{"Lethality",5},{"Vile Poisons",2},{"Improved Sinister Strike",2},{"Improved Slice and Dice",3},{"Dual Wield Specialization",5},{"Precision",5},{"Endurance",2},{"Lightning Reflexes",5},{"Blade Flurry",1},{"Sword Specialization",5},{"Weapon Expertise",2},{"Vitality",1},{"Aggression",3},{"Adrenaline Rush",1},{"Combat Potency",5},{"Surprise Attacks",1} } },
        { category="pve", label="Mutilate", useCase="Off-meta raid DPS alternative and strong 5-man spec. Dagger-based build using Mutilate as the combo builder; competitive on fights with frequent target swaps or when you lack good slow swords. Slightly behind Combat Swords on sustained single-target raid DPS in most gear, but very strong burst with Cold Blood and high poison damage.", talents={ {"Malice",5},{"Ruthlessness",3},{"Murder",2},{"Puncturing Wounds",3},{"Relentless Strikes",1},{"Lethality",5},{"Vile Poisons",5},{"Improved Poisons",5},{"Cold Blood",1},{"Seal Fate",5},{"Find Weakness",5},{"Mutilate",1},{"Improved Sinister Strike",2},{"Lightning Reflexes",3},{"Improved Slice and Dice",3},{"Precision",5},{"Endurance",2},{"Dual Wield Specialization",5} } },
        { category="pvp", label="Sub Shadowstep", useCase="Main arena spec (2v2/3v3/5v5) and the gold-standard rogue PvP build. After the 2.3.2 Combat nerf, 20/0/41 Shadowstep is THE rogue arena build: Preparation resets Vanish/Sprint/Shadowstep/Evasion/Cold Blood, Cheat Death and Cloak of Shadows give survivability, and Shadowstep enables relentless target pressure and gap-closing.", talents={ {"Malice",5},{"Ruthlessness",3},{"Puncturing Wounds",2},{"Lethality",5},{"Vile Poisons",5},{"Opportunity",5},{"Camouflage",5},{"Initiative",3},{"Ghostly Strike",1},{"Improved Ambush",3},{"Setup",3},{"Elusiveness",2},{"Serrated Blades",3},{"Heightened Senses",2},{"Preparation",1},{"Dirty Deeds",1},{"Hemorrhage",1},{"Master of Subtlety",3},{"Deadliness",3},{"Premeditation",1},{"Cheat Death",3},{"Shadowstep",1} } },
        { category="pvp", label="Sub Imp EA variant", useCase="Arena variant for double-DPS cleaves (e.g. Rogue/Warrior or Rogue/Shadow-Priest) that want to stack physical burst on a kill target. Drops some Assassination/poison damage to grab Improved Expose Armor for the deep armor debuff. Pick over the standard sub build specifically in armor-reliant cleave comps; the standard 20/0/41 is better in most other matchups.", talents={ {"Malice",5},{"Improved Eviscerate",3},{"Ruthlessness",3},{"Improved Expose Armor",2},{"Lethality",4},{"Opportunity",5},{"Camouflage",5},{"Initiative",3},{"Ghostly Strike",1},{"Improved Ambush",3},{"Setup",3},{"Elusiveness",2},{"Serrated Blades",3},{"Heightened Senses",2},{"Preparation",1},{"Dirty Deeds",2},{"Hemorrhage",1},{"Master of Subtlety",3},{"Deadliness",5},{"Premeditation",1},{"Cheat Death",3},{"Shadowstep",1} } },
    ...
    PRIEST = {
        ...
        { category="leveling", label="Shadow (10-70)", useCase="Shadow is the standard Priest leveling spec: Spirit Tap regen + Shadowform/Misery/Darkness scaling give near-zero downtime, strong solo DoT+Mind Flay damage, and built-in self-healing via Vampiric Embrace. Final 15/0/46 build reaches all Shadow power spikes (Mind Flay L13ish, Vampiric Embrace, Shadowform, Misery, Vampiric Touch) then dips Discipline for Wand Spec, mana (Meditation/Inner Focus) and shield strength.", order={ "Spirit Tap","Spirit Tap","Spirit Tap","Spirit Tap","Spirit Tap","Improved Shadow Word: Pain","Improved Shadow Word: Pain","Shadow Affinity","Shadow Focus","Shadow Focus","Shadow Focus","Shadow Focus","Shadow Focus","Mind Flay","Improved Mind Blast","Improved Mind Blast","Improved Mind Blast","Improved Mind Blast","Improved Mind Blast","Shadow Reach","Shadow Reach","Shadow Weaving","Shadow Weaving","Shadow Weaving","Shadow Weaving","Shadow Weaving","Vampiric Embrace","Darkness","Darkness","Darkness","Darkness","Darkness","Focused Mind","Focused Mind","Focused Mind","Shadowform","Shadow Power","Shadow Power","Shadow Power","Shadow Power","Shadow Power","Misery","Misery","Misery","Misery","Vampiric Touch","Wand Specialization","Wand Specialization","Wand Specialization","Wand Specialization","Wand Specialization","Improved Power Word: Shield","Improved Power Word: Shield","Improved Power Word: Shield","Martyrdom","Martyrdom","Meditation","Meditation","Meditation","Inner Focus","Improved Power Word: Fortitude" }, talents={ {"Spirit Tap",5},{"Improved Shadow Word: Pain",2},{"Shadow Focus",5},{"Shadow Affinity",1},{"Mind Flay",1},{"Improved Mind Blast",5},{"Shadow Reach",2},{"Shadow Weaving",5},{"Vampiric Embrace",1},{"Darkness",5},{"Focused Mind",3},{"Shadowform",1},{"Shadow Power",5},{"Misery",4},{"Vampiric Touch",1},{"Wand Specialization",5},{"Improved Power Word: Shield",3},{"Martyrdom",2},{"Meditation",3},{"Inner Focus",1},{"Improved Power Word: Fortitude",1} } },
    },
    SHAMAN = {
        { category="pve", label="Elemental", useCase="Raid caster DPS. The go-to ranged Shaman raid spec - brings Totem of Wrath (3% spell hit/crit to the caster group), big Lightning Bolt/Chain Lightning crits, and Bloodlust. Pick this for raid DPS when your group needs a caster slot and the Totem of Wrath buff.", talents={ {"Convection",5},{"Concussion",5},{"Call of Flame",3},{"Elemental Warding",2},{"Call of Thunder",5},{"Elemental Focus",1},{"Eye of the Storm",3},{"Storm Reach",1},{"Elemental Fury",1},{"Unrelenting Storm",5},{"Elemental Precision",3},{"Lightning Mastery",5},{"Elemental Mastery",1},{"Totem of Wrath",1},{"Tidal Focus",5},{"Totemic Focus",5},{"Nature's Guidance",3},{"Healing Focus",2},{"Tidal Mastery",5} } },
        { category="pve", label="Enhancement", useCase="Raid melee DPS. Brings Windfury Totem and Unleashed Rage (10% melee AP) to the melee group, making it a staple in melee-heavy raid comps. Pick this for melee DPS and to buff a melee group's attack power and Windfury uptime.", talents={ {"Convection",2},{"Concussion",5},{"Call of Flame",3},{"Elemental Focus",1},{"Reverberation",5},{"Improved Fire Totems",1},{"Ancestral Knowledge",5},{"Thundering Strikes",5},{"Improved Ghost Wolf",2},{"Enhancing Totems",2},{"Shamanistic Focus",1},{"Flurry",5},{"Spirit Weapons",1},{"Elemental Weapons",3},{"Improved Weapon Totems",2},{"Mental Quickness",3},{"Weapon Mastery",5},{"Dual Wield Specialization",2},{"Dual Wield",1},{"Stormstrike",1},{"Unleashed Rage",5},{"Shamanistic Rage",1} } },
        { category="pve", label="Resto (Raid)", useCase="Raid healer. The most-wanted healer in TBC thanks to Chain Heal (best AoE/group healing in the game), Mana Tide Totem (group mana), Earth Shield (tank) and Bloodlust. Pick this whenever you want to heal raids or dungeons.", talents={ {"Ancestral Knowledge",5},{"Improved Healing Wave",5},{"Tidal Focus",5},{"Improved Reincarnation",2},{"Ancestral Healing",3},{"Totemic Focus",5},{"Nature's Guidance",1},{"Healing Focus",5},{"Tidal Mastery",5},{"Healing Grace",3},{"Restorative Totems",5},{"Healing Way",3},{"Nature's Swiftness",1},{"Purification",5},{"Nature's Guardian",4},{"Mana Tide Totem",1},{"Improved Chain Heal",2},{"Earth Shield",1} } },
        { category="pvp", label="Resto (Arena)", useCase="Arena healer (2v2/3v3/5v5) and the strongest Shaman PvP role. Provides Grounding/Tremor/Earthbind totems, Earth Shield, Nature's Swiftness + instant Healing Wave clutch heals, and Purge. Pick this to play a healing Shaman in rated arena or as a BG flag/raid healer.", talents={ {"Ancestral Knowledge",5},{"Improved Healing Wave",5},{"Tidal Focus",5},{"Improved Reincarnation",2},{"Ancestral Healing",3},{"Totemic Focus",5},{"Healing Focus",5},{"Tidal Mastery",5},{"Healing Grace",3},{"Restorative Totems",4},{"Healing Way",3},{"Nature's Swiftness",1},{"Focused Mind",2},{"Purification",5},{"Nature's Guardian",4},{"Mana Tide Totem",1},{"Improved Chain Heal",2},{"Earth Shield",1} } },
        { category="pvp", label="Enh (Arena/BG)", useCase="Burst melee PvP (2v2 with a healer, and battlegrounds). Big Windfury/Stormstrike spike damage plus Shamanistic Rage for survival and mana, Frost Shock/Earthbind for kiting control. Niche but real in arena - strongest in a melee+healer 2v2; great in battlegrounds. Pick for melee Shaman PvP pressure.", talents={ {"Ancestral Knowledge",5},{"Thundering Strikes",5},{"Improved Ghost Wolf",2},{"Shamanistic Focus",1},{"Anticipation",2},{"Flurry",5},{"Toughness",5},{"Elemental Weapons",3},{"Spirit Weapons",1},{"Mental Quickness",3},{"Weapon Mastery",5},{"Dual Wield Specialization",3},{"Dual Wield",1},{"Stormstrike",1},{"Shamanistic Rage",1},{"Tidal Focus",5},{"Improved Reincarnation",2},{"Totemic Focus",5},{"Nature's Guidance",3},{"Totemic Mastery",1},{"Restorative Totems",2} } },
        { category="pvp", label="Ele (Arena/BG)", useCase="Caster burst PvP (battlegrounds and casual arena). Huge Lightning Bolt/Chain Lightning + Stormstrike-amplified Earth Shock burst, with Eye of the Storm to push casts through damage. Niche/off-meta in rated arena (vulnerable to interrupts/LoS) but strong in BGs and fun for ranged burst. Pick for ranged Shaman PvP pressure.", talents={ {"Convection",5},{"Concussion",5},{"Call of Flame",3},{"Elemental Warding",3},{"Call of Thunder",5},{"Elemental Focus",1},{"Elemental Devastation",3},{"Elemental Fury",1},{"Unrelenting Storm",5},{"Elemental Precision",3},{"Lightning Mastery",5},{"Elemental Mastery",1},{"Tidal Focus",5},{"Totemic Focus",5},{"Nature's Guidance",3},{"Healing Focus",2},{"Tidal Mastery",5},{"Nature's Swiftness",1} } },
    ...
    MAGE = {
        ...
        { category="pve", label="Arcane", useCase="Raid DPS, especially strong in low/mid gear where it out-scales Fire, and excellent burst on Bloodlust/Heroism. Pick this in T4 gear or when you want reliable, gear-independent damage and Scorch-free play.", talents={ {"Arcane Subtlety",2},{"Arcane Focus",5},{"Magic Absorption",2},{"Arcane Concentration",5},{"Arcane Impact",3},{"Arcane Meditation",3},{"Presence of Mind",1},{"Arcane Mind",5},{"Arcane Instability",3},{"Arcane Potency",2},{"Empowered Arcane Missiles",3},{"Arcane Power",1},{"Spell Power",2},{"Mind Mastery",5},{"Improved Frostbolt",5},{"Elemental Precision",3},{"Ice Shards",5},{"Piercing Ice",3},{"Icy Veins",1},{"Frost Channeling",2} } },
        ...
        { category="pvp", label="Frost", useCase="Primary Arena build (2v2/3v3) and the king of control. Deep Frost for Summon Water Elemental, Ice Barrier and Shatter burst. Pick this for nearly all Mage PvP; best with a healer (e.g. Mage/Rogue/Priest, RMP).", talents={ {"Arcane Subtlety",2},{"Arcane Focus",5},{"Improved Arcane Missiles",3},{"Improved Frostbolt",5},{"Elemental Precision",3},{"Ice Shards",5},{"Frostbite",3},{"Improved Frost Nova",2},{"Permafrost",2},{"Piercing Ice",3},{"Icy Veins",1},{"Frost Channeling",3},{"Arctic Reach",2},{"Shatter",3},{"Ice Floes",2},{"Winter's Chill",5},{"Ice Barrier",1},{"Arctic Winds",5},{"Empowered Frostbolt",4},{"Cold Snap",1},{"Summon Water Elemental",1} } },
        { category="pvp", label="PoM Pyro", useCase="Niche/off-meta burst PvP (3v3/5v5 and BGs). The 'PoM Pyro / Deep Fire' cheese: Presence of Mind into instant Pyroblast for a huge opener, plus strong AoE CC (Dragon's Breath, Blast Wave). Pick it for fast-kill comps and battlegrounds; falls off badly vs teams with a healer. Frost remains the standard Mage PvP choice.", talents={ {"Arcane Subtlety",2},{"Arcane Focus",5},{"Arcane Concentration",5},{"Magic Absorption",3},{"Magic Attunement",2},{"Arcane Meditation",3},{"Presence of Mind",1},{"Improved Fireball",5},{"Impact",5},{"Ignite",5},{"Pyroblast",1},{"Improved Scorch",3},{"Master of Elements",3},{"Playing with Fire",3},{"Critical Mass",3},{"Blast Wave",1},{"Fire Power",5},{"Pyromaniac",3},{"Combustion",1},{"Empowered Fireball",2} } },
        { category="leveling", label="Frost (10-70)", useCase="Deep Frost (10/0/51) is THE standard Mage leveling spec: safest and most mana-efficient, with constant chill/freeze control, Shatter burst, Ice Barrier survivability, Icy Veins, and a Water Elemental pet â€” letting you kite, grind, and quest without downtime.", order={ "Improved Frostbolt","Improved Frostbolt","Improved Frostbolt","Improved Frostbolt","Improved Frostbolt","Elemental Precision","Elemental Precision","Elemental Precision","Frostbite","Frostbite","Frostbite","Ice Shards","Ice Shards","Ice Shards","Ice Shards","Ice Shards","Improved Frost Nova","Improved Frost Nova","Piercing Ice","Piercing Ice","Piercing Ice","Icy Veins","Frost Channeling","Frost Channeling","Frost Channeling","Shatter","Shatter","Shatter","Shatter","Shatter","Arctic Reach","Arctic Reach","Cold Snap","Winter's Chill","Winter's Chill","Winter's Chill","Winter's Chill","Winter's Chill","Ice Floes","Ice Floes","Ice Barrier","Arctic Winds","Arctic Winds","Arctic Winds","Arctic Winds","Arctic Winds","Empowered Frostbolt","Empowered Frostbolt","Empowered Frostbolt","Empowered Frostbolt","Summon Water Elemental","Arcane Subtlety","Arcane Subtlety","Arcane Focus","Arcane Focus","Arcane Focus","Arcane Concentration","Arcane Concentration","Arcane Concentration","Arcane Concentration","Arcane Concentration" }, talents={ {"Improved Frostbolt",5},{"Elemental Precision",3},{"Frostbite",3},{"Piercing Ice",3},{"Ice Shards",5},{"Cold Snap",1},{"Improved Frost Nova",2},{"Frost Channeling",3},{"Icy Veins",1},{"Shatter",5},{"Ice Barrier",1},{"Arctic Winds",5},{"Empowered Frostbolt",4},{"Summon Water Elemental",1},{"Arctic Reach",2},{"Winter's Chill",5},{"Ice Floes",2},{"Arcane Subtlety",2},{"Arcane Focus",3},{"Arcane Concentration",5} } },
    },
    WARLOCK = {
        { category="pve", label="DS/Ruin", useCase="Raid DPS - the standard top single-target Warlock raid build. Sacrifice the Succubus (Demonic Sacrifice) for +15% Shadow damage, then spam Shadow Bolt with Ruin (doubled crit damage). Scales the hardest of any Warlock spec into T5/T6. The 0/21/40 tree covers both Shadow (Improved Shadow Bolt, Shadow and Flame) and Fire (Improved Immolate, Emberstorm, Conflagrate) so you never respec between fights.", talents={ {"Improved Shadow Bolt",5},{"Bane",5},{"Improved Firebolt",2},{"Improved Immolate",3},{"Devastation",2},{"Shadowburn",1},{"Destructive Reach",2},{"Improved Searing Pain",3},{"Pyroclasm",2},{"Ruin",1},{"Nether Protection",3},{"Emberstorm",5},{"Conflagrate",1},{"Soul Leech",1},{"Shadow and Flame",4},{"Improved Imp",3},{"Demonic Embrace",5},{"Fel Intellect",3},{"Improved Voidwalker",3},{"Fel Domination",1},{"Fel Stamina",3},{"Master Summoner",2},{"Demonic Sacrifice",1} } },
        { category="pve", label="UA/Malediction", useCase="Raid DPS with raid-wide utility. Brings Malediction (boosts the raid's Curse of the Elements to +13% spell damage taken on the boss) plus full DoT pressure including Unstable Affliction. Strong early-gear DPS and excellent on movement / multi-target fights. Bring at least one Affliction lock per raid for Malediction. Competitive but slightly behind DS/Ruin on pure single-target at high gear.", talents={ {"Suppression",5},{"Improved Corruption",5},{"Improved Life Tap",2},{"Soul Siphon",2},{"Fel Concentration",5},{"Amplify Curse",1},{"Nightfall",2},{"Empowered Corruption",3},{"Siphon Life",1},{"Shadow Mastery",5},{"Contagion",5},{"Dark Pact",1},{"Malediction",3},{"Unstable Affliction",1},{"Improved Shadow Bolt",5},{"Bane",5},{"Devastation",5},{"Shadowburn",1},{"Destructive Reach",2},{"Improved Searing Pain",2} } },
        { category="pve", label="Felguard", useCase="Niche raid DPS via Summon Felguard (the 41-point Demonology capstone). The Felguard pet plus Demonic Knowledge, Master Demonologist and Soul Link gives strong, gear-light damage with low DoT-tracking. A legitimate but off-meta raid pick versus DS/Ruin and Affliction; best for players who want pet-driven gameplay.", talents={ {"Improved Corruption",1},{"Improved Imp",3},{"Demonic Embrace",5},{"Fel Intellect",3},{"Improved Voidwalker",3},{"Fel Domination",1},{"Fel Stamina",3},{"Master Summoner",2},{"Unholy Power",5},{"Demonic Sacrifice",1},{"Master Demonologist",5},{"Soul Link",1},{"Demonic Knowledge",3},{"Demonic Tactics",5},{"Summon Felguard",1},{"Improved Shadow Bolt",5},{"Cataclysm",1},{"Bane",5},{"Devastation",5},{"Improved Firebolt",2},{"Destructive Reach",1} } },
        ...
        { category="pvp", label="Deep Affliction", useCase="Off-meta PvP variant for battlegrounds and aggressive caster-cleave 3v3/5v5 comps. Goes deep into Affliction for Unstable Affliction (anti-dispel; UA punishes dispels) plus full instant-cast DoT pressure, trading some SL/SL tankiness for kill pressure. Real but less common than SL/SL - pick it for BGs or dispel-heavy comps where UA shines.", talents={ {"Suppression",5},{"Improved Corruption",5},{"Improved Drain Soul",2},{"Improved Life Tap",2},{"Soul Siphon",2},{"Fel Concentration",5},{"Amplify Curse",1},{"Nightfall",2},{"Empowered Corruption",3},{"Siphon Life",1},{"Shadow Mastery",5},{"Contagion",5},{"Dark Pact",1},{"Improved Howl of Terror",2},{"Malediction",1},{"Unstable Affliction",1},{"Improved Imp",3},{"Demonic Embrace",5},{"Fel Intellect",2},{"Fel Stamina",3},{"Demonic Aegis",3},{"Master Summoner",2} } },
        { category="leveling", label="Affliction (10-70)", useCase="Affliction is the go-to TBC leveling spec: instant-cast Corruption plus stacked DoTs let you pull, dot, and move to the next mob while Drain Life/Life Tap and pet tanking give near-endless sustain with minimal downtime.", order={ "Demonic Embrace","Demonic Embrace","Demonic Embrace","Demonic Embrace","Demonic Embrace","Suppression","Suppression","Suppression","Suppression","Suppression","Improved Corruption","Improved Corruption","Improved Corruption","Improved Corruption","Improved Corruption","Improved Life Tap","Improved Life Tap","Improved Drain Soul","Improved Drain Soul","Soul Siphon","Soul Siphon","Improved Curse of Weakness","Improved Curse of Weakness","Fel Concentration","Fel Concentration","Fel Concentration","Fel Concentration","Fel Concentration","Improved Curse of Agony","Improved Curse of Agony","Amplify Curse","Grim Reach","Grim Reach","Nightfall","Nightfall","Empowered Corruption","Empowered Corruption","Empowered Corruption","Shadow Embrace","Shadow Embrace","Shadow Embrace","Shadow Embrace","Shadow Embrace","Siphon Life","Shadow Mastery","Shadow Mastery","Shadow Mastery","Shadow Mastery","Shadow Mastery","Contagion","Contagion","Contagion","Contagion","Contagion","Dark Pact","Improved Howl of Terror","Improved Howl of Terror","Malediction","Malediction","Malediction","Unstable Affliction" }, talents={ {"Suppression",5},{"Improved Corruption",5},{"Improved Curse of Weakness",2},{"Improved Life Tap",2},{"Improved Drain Soul",2},{"Soul Siphon",2},{"Improved Curse of Agony",2},{"Fel Concentration",5},{"Amplify Curse",1},{"Grim Reach",2},{"Nightfall",2},{"Empowered Corruption",3},{"Shadow Embrace",5},{"Siphon Life",1},{"Shadow Mastery",5},{"Contagion",5},{"Dark Pact",1},{"Improved Howl of Terror",2},{"Malediction",3},{"Unstable Affliction",1},{"Demonic Embrace",5} } },
    },
    DRUID = {
        { category="pve", label="Boomkin", useCase="Raid caster DPS", talents={ {"Starlight Wrath",5},{"Nature's Grasp",1},{"Improved Nature's Grasp",2},{"Focused Starlight",2},{"Improved Moonfire",2},{"Insect Swarm",1},{"Nature's Reach",2},{"Vengeance",5},{"Celestial Focus",3},{"Lunar Guidance",3},{"Nature's Grace",1},{"Moonglow",3},{"Moonfury",5},{"Balance of Power",2},{"Dreamstate",3},{"Moonkin Form",1},{"Improved Faerie Fire",3},{"Wrath of Cenarius",5},{"Force of Nature",1},{"Furor",5},{"Naturalist",5},{"Intensity",1} } },
        ...
        { category="pve", label="Resto / ToL", useCase="Raid healer", talents={ {"Starlight Wrath",5},{"Control of Nature",3},{"Improved Mark of the Wild",5},{"Furor",5},{"Naturalist",3},{"Subtlety",5},{"Intensity",3},{"Nature's Focus",2},{"Improved Rejuvenation",3},{"Tranquil Spirit",5},{"Nature's Swiftness",1},{"Gift of Nature",5},{"Improved Tranquility",2},{"Empowered Touch",2},{"Living Spirit",3},{"Swiftmend",1},{"Natural Perfection",3},{"Empowered Rejuvenation",4},{"Tree of Life",1} } },
        ...
        { category="leveling", label="Feral (10-70)", useCase="Feral is the go-to TBC Druid leveling spec: strong sustained melee damage in Cat Form, great survivability and mobility (Feral Swiftness +30% speed, Bear/Dire Bear tankiness), and near-zero downtime by powershift-healing between pulls. This 41/20 build rushes the core Cat/Bear damage and survivability talents, then dips Restoration for Furor (powershifting energy/rage), Naturalist (+10% physical damage), Natural Shapeshifter, Omen of Clarity, and Intensity.", order={ "Ferocity","Ferocity","Ferocity","Ferocity","Ferocity","Thick Hide","Thick Hide","Thick Hide","Brutal Impact","Brutal Impact","Feral Swiftness","Feral Swiftness","Sharpened Claws","Sharpened Claws","Sharpened Claws","Predatory Strikes","Predatory Strikes","Predatory Strikes","Primal Fury","Primal Fury","Savage Fury","Savage Fury","Faerie Fire (Feral)","Nurturing Instinct","Nurturing Instinct","Heart of the Wild","Heart of the Wild","Heart of the Wild","Heart of the Wild","Heart of the Wild","Survival of the Fittest","Survival of the Fittest","Survival of the Fittest","Leader of the Pack","Improved Leader of the Pack","Improved Leader of the Pack","Predatory Instincts","Predatory Instincts","Predatory Instincts","Predatory Instincts","Predatory Instincts","Mangle","Furor","Furor","Furor","Furor","Furor","Naturalist","Naturalist","Naturalist","Naturalist","Naturalist","Natural Shapeshifter","Natural Shapeshifter","Natural Shapeshifter","Omen of Clarity","Intensity","Intensity","Intensity","Improved Mark of the Wild","Improved Mark of the Wild" }, talents={ {"Ferocity",5},{"Thick Hide",3},{"Brutal Impact",2},{"Feral Swiftness",2},{"Sharpened Claws",3},{"Predatory Strikes",3},{"Savage Fury",2},{"Primal Fury",2},{"Heart of the Wild",5},{"Faerie Fire (Feral)",1},{"Nurturing Instinct",2},{"Survival of the Fittest",3},{"Leader of the Pack",1},{"Improved Leader of the Pack",2},{"Predatory Instincts",5},{"Mangle",1},{"Furor",5},{"Naturalist",5},{"Natural Shapeshifter",3},{"Omen of Clarity",1},{"Intensity",3},{"Improved Mark of the Wild",2} } },
    },
}
        ...
        for index = 1, (GetNumTalents(tab, false, false, group) or 0) do
            ...
            if name and not (active.skip and active.skip[strlower(name)]) then
                ...
                if want then
                    ...
                    if (rank or 0) < want and pointsInTab >= (tier - 1) * 5 then
...
local function findNextOrdered()
    ...
    for tab = 1, numTabs do
        tabTotal[tab] = 0
        for index = 1, (GetNumTalents(tab, false, false, group) or 0) do
            local name, _, t, _, rank, maxRank = GetTalentInfo(tab, index, false, false, group)
            if name then
                local key = strlower(name)
                liveRank[key] = rank or 0
                loc[key] = { tab, index, t or 1, maxRank or 99 }
    ...
    for _, talentName in ipairs(active.order) do
        ...
        local l = loc[key]
        if l and not (skip and skip[key]) then
            -- Clamp the running "want" against the talent's real max rank, so an
            -- order that happens to list a talent more times than it can hold never
            -- asks for an (N+1)th point that can't exist (which would otherwise be
            -- handed back every pass and only stopped by the watchdog).
            local want = seen[key]
            if want > l[4] then want = l[4] end
            if (liveRank[key] or 0) < want and tabTotal[l[1]] >= (l[3] - 1) * 5 then
                return l[1], l[2]
            end
        end
    end
...
local function applyNextPoint()
    ...
    if not tab then
        ...
        local left = GetUnspentPoints(active.group)
        if left > 0 then
            aCount("incomplete")
...
local function beginApply(build)
    ...
    -- Anonymous usage signal (no-op unless the player opted into Wago analytics):
    -- which class and spec category get applied, and how often.
    aCount("apply")
    if build.category then aCount("apply_" .. build.category) end
    local _, classFile = UnitClass("player")
    if classFile then aSwitch("class_" .. classFile) end
